 ...
 * @generated
 */
public class ComicBooksSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ComicBooksPackage.COMIC_BOOK_COLLECTION: {
				ComicBookCollection comicBookCollection = (ComicBookCollection)theEObject;
				T result = caseComicBookCollection(comicBookCollection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComicBooksPackage.PUBLISHER: {
				Publisher publisher = (Publisher)theEObject;
				T result = casePublisher(publisher);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComicBooksPackage.SERIES: {
				Series series = (Series)theEObject;
				T result = caseSeries(series);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComicBooksPackage.BOOK: {
				Book book = (Book)theEObject;
				T result = caseBook(book);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComicBooksPackage.ARTIST: {
				Artist artist = (Artist)theEObject;
				T result = caseArtist(artist);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComicBooksPackage.EDITOR: {
				Editor editor = (Editor)theEObject;
				T result = caseEditor(editor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComicBooksPackage.WRITER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Comic Book Collection</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Comic Book Collection</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComicBookCollection(ComicBookCollection object) {
		return null;
	}
